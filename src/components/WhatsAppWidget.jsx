...
const WHATSAPP_NUMBER = '5522996050902'
        ...
        >
          ...
          <div className="flex items-center gap-3 px-4 py-3" style={{ background: '#075E54' }}>
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white font-semibold text-sm leading-tight">Chazan Tech</p>
          ...
          >
            ...
            <div className="flex justify-center mb-1">
              <span
                ...
                style={{ background: 'rgba(255,255,255,0.75)', color: '#667781' }}
              >
                HOJE
              </span>
            </div>
            ...
            {!selected ? (
              <>
                <ReceivedBubble time={time}>
                  Selecione uma das dúvidas abaixo ou clique no botão para falar diretamente com a gente:
                </ReceivedBubble>
                ...
                <div className="flex flex-col gap-1.5 mt-1">
                  {FAQS.map((faq) => (
                    <button
                      ...
                      style={{ background: 'white', borderColor: '#25D366', color: '#128C7E' }}
                    >
                      {faq.q}
                    </button>
                  ))}
              ...
              <>
                ...
                <ReceivedBubble time={time}>
                  Ficou com mais alguma dúvida? Pode falar com a gente no WhatsApp! 😊
                </ReceivedBubble>
  ...
  return (
    <div className="flex max-w-[88%]">
      ...
      >
        ...
        <span className="block text-right text-[10px] mt-1" style={{ color: '#8696a0' }}>
          {time}
        </span>
      </div>
    </div>
